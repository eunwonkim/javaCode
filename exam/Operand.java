...
public class Operand {
	...
	public static void main(String[] args) {
		...
		// 2. 대입연산자
		//    - 변수에 값을 대입할때 사용하는 연산자.(ex) =(할당), +=(누적), -=, *=, /=
		//  좌항을 a, 우항을 b라 두고 진행.
		//  a = b : 변수 a에 b의 내용을 할당한다.
		//  a +=b : 변수 a에 b의 내용을 더한 후 결과값을 할당.
	    ...
	    //  a |=b : 변수 a에 변수 a와 b의 내용을 or 연산 후 결과값을 할당.
	    //  a ^=b : 변수 a에 변수 a와 b의 내용을 xor 연산 후 결과값을 할당.
...
//		System.out.print(b);
	  ...
	  //   System.out.println((num1 <= num2));
		...
		// NOT : 0->1 / 1->0 결과가 참이면 거짓을 출력 결과가 거짓이면 참을 출력. ->청개구리를 생각하면된다
		// !<--- not
		// && <--- and
		// || <--- or
	    ...
	    // AND OR 조건 예시2   (AND는 조건이 완벽해야하고, OR는 둘중 하나조건만 만족해도 된다)
	    // 1. 회원가입을 받는데 조건이 나이가 20살 이상이고 학력이 대졸인 사람
	    //    -OR조건
